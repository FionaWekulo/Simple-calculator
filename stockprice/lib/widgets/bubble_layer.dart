...
class _BubbleLayerState extends State<BubbleLayer>
  ...
  void initState() {
    ...
    _animationValue =
        Tween<double>(begin: 0.9, end: 1.3).animate(_animationController);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Positioned(left: -75, top: 10, child: bubble(160, 160)),
          Positioned(right: -70, top: -70, child: bubble(200, 200)),
          Positioned(
              right: 50,
              top: MediaQuery.of(context).size.height / 2 - 100,
              child: bubble(100, 100)),
          Positioned(left: 50, bottom: 100, child: bubble(100, 100)),
          //real content
          widget.child
        ],
      ),
